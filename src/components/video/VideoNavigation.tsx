...
export default function VideoNavigation({ video, onNext, onPrev }: VideoNavigationProps) {
  return (
    <>
      <h3 className="text-lg font-medium mb-3 text-center text-text dark:text-dark-text">
        {video?.title} <span className="text-text/50 dark:text-dark-text/50 text-base">({video?.date})</span>
      </h3>
